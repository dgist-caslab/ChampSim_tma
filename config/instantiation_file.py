...
pmem_fmtstr = 'MEMORY_CONTROLLER {name}{{{frequency}, {io_freq}, {tRP}, {tRCD}, {tCAS}, {turn_around_time}, {{{_ulptr}}}, {channel_width}, {channels}, {wq_size}, {banks}, {ranks}, {columns}, {rows}, 0}};'
spmem_fmtstr = 'MEMORY_CONTROLLER {name}{{{frequency}, {io_freq}, {tRP}, {tRCD}, {tCAS}, {turn_around_time}, {{{_ulptr}}}, {channel_width}, {channels}, {wq_size}, {banks}, {ranks}, {columns}, {rows}, 1}};'
vmem_fmtstr = 'VirtualMemory vmem{{{pte_page_size}, {num_levels}, {minor_fault_penalty}, {dram_name}}};'
vmem_fmtstr_slow = 'VirtualMemory vmem{{{pte_page_size}, {num_levels}, {minor_fault_penalty}, {dram_name}, {slow_dram_name}}};'
...
def get_instantiation_lines_slow(cores, caches, ptws, pmem, spmem, vmem):
    ...
    yield spmem_fmtstr.format(
            ...
            **spmem)
    yield vmem_fmtstr_slow.format(dram_name=pmem['name'], slow_dram_name=spmem['name'], **vmem)
