...
# TRACE_FILE_A=/home/phw/workspace/traces/Champsim/spec/603.bwaves_s-2931B.champsimtrace.xz  # Sample trace file path
TRACE_FILE_A=/home/phw/workspace/traces/Champsim/spec/649.fotonik3d_s-7084B.champsimtrace.xz  # Sample trace file path
# TRACE_FEED_A=/home/phw/workspace/scripts/about_trace/parsed_bingo_bits_S1B/603.bwaves_s-2931B.csv
TRACE_FEED_A=/home/phw/workspace/scripts/about_trace/parsed_bingo_output/649.fotonik3d_s-7084B.csv
...
NUM_WARMUP=1000000    # 10M instructions for warmup
...
run_simulator() {
    ...
    echo "$SIM_ROOT/bin/champsim --warmup-instructions $NUM_WARMUP --simulation-instructions $NUM_SIMUL $trace_file_a --feeds $trace_feed_a"

    # Execute the simulator and log the output
    # $SIM_ROOT/bin/champsim --warmup-instructions $NUM_WARMUP --simulation-instructions $NUM_SIMUL $trace_file_a
    $SIM_ROOT/bin/champsim --warmup-instructions $NUM_WARMUP --simulation-instructions $NUM_SIMUL $trace_file_a --feeds $trace_feed_a
